  ...
  return (
    <div className="App">
      ...
      <div className="cryptoDisplay">
        ...
        {filteredCoins.map((coin) => { //it was listOfCoins.map-------we got the listofcoins state and we want
          ...
          //usstteki map coin deki infoyu hemen altta pass ettik
            return(
            <Coin name={coin.name} twitterUrl={coin.twitterUrl} icon={coin.icon} price={coin.price} rank={coin.rank} symbol={coin.symbol}/>
